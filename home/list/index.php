...
<div class="blog-container">
  ...
  <div class="blog-body">
    ...
    <div class="blog-tags">
    <ul>
        <li><a href="#">Key Area:   <?php echo $keyarea; ?></a></li>  
        <li><a href="#">Status:   <?php echo $status; ?></a></li>      
    
      </ul>
      <ul>
        <li><a href="#">Venue:   <?php echo $venue; ?></a></li>
        <li><a href="#">Date Posted:   <?php echo $date; ?></a></li>
      
      </ul>
      <ul>
        <li><a href="#">Start Time:   <?php echo $starttime ?></a></li>
        <li><a href="#">End Time:   <?php echo $endtime; ?></a></li>
