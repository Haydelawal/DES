...
<br>
<p class="card-text"><?php echo $minute;?></p>
</div>
</div>
...
<div class="card">
<div class="card-header">
<h5 class="card-title">Key Area</h5>
<br>

<p class="card-text"><?php echo $keyarea;?></p>
</div>
</div>
...
<p class="card-text"><?php echo $starttime;?></p>
</div>
</div>
...
<p class="card-text"><?php echo $endtime;?></p>
</div>
</div>
...
<p class="card-text"><?php echo $members;?></p>
</div>
</div>
