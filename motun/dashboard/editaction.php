...
<div class="form-group row">
    ...
    <div class="col-md-10">
    <input rows="5" cols="5" class="form-control" placeholder="Enter text here" name="minute" value=" <?php echo $minute;?>" required>
    </div>
    </div>
...
<div class="checkbox">
<label>
<input type="checkbox" name="members" value="Prof. Toyin."> Prof. Toyin
</label>
</div>
<div class="checkbox">
<label>
<input type="checkbox" name="members" value="Engr. Aiyeneko."> Engr. Aiyeneko
</label>
</div>
<div class="checkbox">
<label>
<input type="checkbox" name="members" value="Prof. Rahman."> Prof. Rahman
</label>
</div>
<div class="checkbox">
    <label>
    <input type="checkbox" name="members" value="Dr. Raji."> Dr. Raji
    </label>
    </div>
    <div class="checkbox">
        <label>
        <input type="checkbox" name="members" value="Dr. Owate."> Dr. Owate
        </label>
        </div>
        <div class="checkbox">
            <label>
            <input type="checkbox" name="members" value="Dr. Oloyede."> Dr. Oloyede
            </label>
            </div>
</div>
</div>
